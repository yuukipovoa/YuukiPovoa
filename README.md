...
I’m an IT professional passionate about **IT Infrastructure, Networking, Technical Support, Field Service, Data Analysis, and Full Stack Development**.

Throughout my academic and professional journey, I’ve gained hands-on experience with **technical support, hardware and software maintenance, networks, data, programming, and IT solutions**. I hold a degree in **Systems Analysis and Development** and have experience working in both corporate environments and as an IT instructor.

I’m constantly looking to grow, take on new challenges, and build a career where I can combine **technology, problem-solving, and continuous learning** to create practical solutions and make an impact.

If you enjoyed my profile, feel free to **connect with me**. I’m always open to exchanging knowledge, collaborating on projects, and exploring new opportunities in IT.
...
<p align="center">
  <strong>Python • Java • JavaScript • C# • Ruby • TypeScript • C • C++ • MySQL • SQL Server • .NET • Linux • Windows • Android • Git • GitHub • Docker • AWS • Google Cloud • Unity • Blender • Photoshop • Illustrator • After Effects • Premiere Pro • DaVinci Resolve • Canva • OBS Studio • Mixcraft • Microsoft Excel</strong>
</p>
